...
@app.post("/products")
async def register(product_info:Shop):

        with open(r"C:\Users\33122\Desktop\2507Code\03FastApi\db\products.txt",'a+',encoding='utf-8') as f:
            f.write("\n")
            f.write(product_info.model_dump_json())
        # print(type(product_info.model_dump()))    # 字典
        print(product_info.model_dump_json())  # 字符串
        return product_info
